...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2019 at 08:25 PM
...
CREATE TABLE `pokemons` (
  ...
  `Sp. Attack` int(7) DEFAULT NULL,
  `Sp. Defense` int(7) DEFAULT NULL,
  `Speed` int(5) DEFAULT NULL,
  `Generation` int(10) DEFAULT NULL,
  `Legendary` varchar(9) DEFAULT NULL
...
INSERT INTO `pokemons` (`No.`, `Name`, `Type 1`, `Type 2`, `Total`, `HP`, `Attack`, `Defense`, `Sp. Attack`, `Sp. Defense`, `Speed`, `Generation`, `Legendary`) VALUES
